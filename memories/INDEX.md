...
| [map-ledger-field-encoding.md](map-ledger-field-encoding.md) | Empirical compactc emission for `Map<K, V>` insert/lookup/member, opcode reference. Stage 1 (`Map::contains`) landed on-chain compatible; insert/get/remove pending. |
