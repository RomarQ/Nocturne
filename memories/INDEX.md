...
| [scope-blockers.md](scope-blockers.md) | Feature work blocked on upstream coordination, design decisions, or explicit owner policy — env context, sum-type encoding, crate rename, cross-contract, ZKIR v3. |
